<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM user_info WHERE user_login_id = '$myuser_login_id' and user_category_id='$user_category_id' and password = md5('$mypassword')";
      ...
      if($count == 1) {
		 ...
		 $_SESSION['user_category_id'] = $row[3];
